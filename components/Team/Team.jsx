...
const Team = () => {
  return (
    <section className="max-w-[1296px] mx-auto my-[70px] md:mt-[102px] md:mb-[102px]" id="team">
      ...
      <div className="flex flex-wrap gap-6 mx-2 2xl:mx-0 justify-center">
        {team.map((member) => (
          <div
            className="w-[310px] sm:w-[416px] bg-[#E8EFFF] rounded-[30px] relative team hover:shadow-[0px_50px_100px_-20px_rgba(50,50,93,0.4)] duration-300"
            key={member.id}
          >
